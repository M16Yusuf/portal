    ...
    <div id="carouselExampleCaptions" class="carousel slide wow zoomIn" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="<?= base_url('assets/') ?>img/1.jpg" class="d-block w-100 img-fluid" alt="...">
          <div class="carousel-caption d-none d-md-block">
            <h5>Desa Laksanamekar</h5>
            <p>Penghayatan dan pengalaman Pancasila.</p>
          </div>
        </div>
        <div class="carousel-item">
          ...
          <div class="carousel-caption d-none d-md-block">
            <h5>Desa Laksanamekar</h5>
            <p>Gotong Royong, Pangan, dan Sandang.</p>
          </div>
        </div>
        <div class="carousel-item">
  ...
  <div class="page-banner home-banner">
    <div class="row align-items-center flex-wrap-reverse h-100">
          <div class="col-md-6 py-5 wow fadeInLeft">
            ...
            <a href="https://goo.gl/maps/BEDSajKsLTRNcZWv6" class="btn btn-primary btn-split stretched-link">Google Maps<div class="fab"><span class="mai-location-outline"></span></div></a>
          </div>
  ...
  <div class="container">
      ...
      <div class="row align-items-center">
        <div class="col-lg-6 py-3 wow fadeInUp">
          ...
          <a href="https://goo.gl/maps/b2nffwVLpMdd8S6e9" class="btn btn-primary mt-3">Selengkapnya</a>
        </div>
